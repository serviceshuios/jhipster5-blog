...
import com.huios.blog.web.rest.util.HeaderUtil;
...
public class BlogResource {
    ...
    public List<Blog> getAllBlogs() {
        log.debug("REST request to get all your Blogs");
        // ici modification afin de n'avoir que les blogs du user connecté
    ...
    public ResponseEntity<?> getBlog(@PathVariable Long id) {
        ...
        //bloquer l'accès via modification url à un blog dont on est pas propriétaire
